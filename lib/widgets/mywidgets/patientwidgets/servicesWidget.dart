...
class _ServicesCardWidgetState extends State<ServicesCardWidget> {
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      elevation: 0,
                      color: _subscriptionState(widget.service.isSubscribed),
                      shape: RoundedRectangleBorder(
                      ...
                      onPressed: (){
                        showDialog<String>(
                          ...
                          builder: (BuildContext context) => AlertDialog(
                            title: const Text('Service Subscription'),
                      ...
                      child: Text(
                        _subscriptionValue(widget.service.isSubscribed),
                        style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: 14.0,
                          color: Theme.of(context).primaryColor,
  ...
  Color _subscriptionState(bool isSubscribed){
    if(isSubscribed){
  ...
  String _subscriptionValue(bool isSubscribed){
    if(isSubscribed){
      return "Subscribed";
    }else{
