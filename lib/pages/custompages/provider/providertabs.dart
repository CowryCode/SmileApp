...
//
//   const ProviderTabsWidget({Key key, this.acountInfos}) : super(key: key);
//
//
//   @override
...
// }
//
// class _BubblesState extends State<ProviderTabsWidget> with SingleTickerProviderStateMixin {
...
//       case 0 :
//         currentTitle = 'Home';
//         return ProviderHome(value: "${widget.acountInfos[0]}");
//       case 1 :
//         currentTitle = 'chat';
