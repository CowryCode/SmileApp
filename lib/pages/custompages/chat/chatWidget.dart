            ...
            new Flexible(
              child: new Column(
                ...
                //  new Text(this.chat.user!.name!, style: TextStyle(fontFamily: 'Poppins',color: Theme.of(context).accentColor,fontWeight: FontWeight.bold),),
                  ...
                  new Text(this.chat.time!, style: TextStyle(fontFamily: 'Poppins',color: Theme.of(context).primaryColor, fontSize: 10.0),),
                ],
              ),
            ),
            new Column(
              ...
              child: new Column(
                ...
                children: <Widget>[
                 // new Text(currentDoctor.name!, style: TextStyle(fontFamily: 'Poppins',color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),
                  new Text('AI Bot', style: TextStyle(fontFamily: 'Poppins',color: Theme.of(context).primaryColor,fontWeight: FontWeight.bold),),
                  new Container(
                    margin: const EdgeInsets.only(top: 5.0),
